...
//    	return mTitle.getHeight();
    ...
    public void onLocationChanged(Location location) {
        EmulatorView.latitude = location.getLatitude();
        EmulatorView.longitude = location.getLongitude();
    }
...
*/
    ...
    private void update() {
        ...
        try {
            ...
            send_message();
            /*String crash_message = stringRead.substring(0, 10);
            if(crash_message.equalsIgnoreCase("Helmet2020")){
                send_message();
            }*/
